...
namespace ptl
{
	...
	void ImGuiLayer::OnEvent(Event &event)
	{
		...
		dispatcher.Dispatch<WindowResizeEvent>(
			PTL_BIND_EVENT_FN(ImGuiLayer::OnWindowResizeEvent));
		dispatcher.Dispatch<KeyPressEvent>(
			PTL_BIND_EVENT_FN(ImGuiLayer::OnKeyPressEvent));
		dispatcher.Dispatch<KeyReleaseEvent>(
			PTL_BIND_EVENT_FN(ImGuiLayer::OnKeyReleaseEvent));
		dispatcher.Dispatch<KeyTypeEvent>(
			PTL_BIND_EVENT_FN(ImGuiLayer::OnKeyTypeEvent));
		dispatcher.Dispatch<MouseButtonPressEvent>(
			PTL_BIND_EVENT_FN(ImGuiLayer::OnMouseButtonPressEvent));
		dispatcher.Dispatch<MouseButtonReleaseEvent>(
			PTL_BIND_EVENT_FN(ImGuiLayer::OnMouseButtonReleaseEvent));
		dispatcher.Dispatch<MouseMoveEvent>(
			PTL_BIND_EVENT_FN(ImGuiLayer::OnMouseMoveEvent));
		dispatcher.Dispatch<MouseScrollEvent>(
			PTL_BIND_EVENT_FN(ImGuiLayer::OnMouseScrollEvent));
	}
	...
	bool ImGuiLayer::OnWindowResizeEvent(WindowResizeEvent &event)
	{
		ImGuiIO &io = ImGui::GetIO();
		io.DisplaySize =
			ImVec2((float)event.GetWidth(), (float)event.GetHeight());
		return false;
	}
	...
	bool ImGuiLayer::OnMouseButtonPressEvent(MouseButtonPressEvent &event)
	{
		...
		ImGuiMouseButton button =
			PtlToImGuiMouseButtonCode(event.GetMouseButton());
	...
	ImGuiMouseButton ImGuiLayer::PtlToImGuiMouseButtonCode(
		MouseButtonCode button)
	{
		switch (button)
		{
		case MouseButtonCode::_1:
			return ImGuiMouseButton_Left;
		case MouseButtonCode::_2:
			return ImGuiMouseButton_Right;
		case MouseButtonCode::_3:
